...
const PopupRegister = () => {
  ...
  useEffect(() => {
    setIsValidFormData(Object.values(verifyInput).every((x) => x === ""));
  }, [verifyInput, data]);
  ...
  const handleInputChange = (e) => {
    ...
    setVerifyInput((pre) => ({ ...pre, [id]: errorMessage }));
  };
  ...
  return (
    <>
      <motion.button
        ...
        className="mt-3 mb-2 text-[1.4rem] z-50 font-[600] flex items-center gap-1 text-blue-600 underline"
      >
        <CiGlobe size={20} />
