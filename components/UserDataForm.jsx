...
const UserDataForm = () => {
  ...
  const [formData, setFormData] = useState({
    name: "Cao Hoài Sang",
    sex: "Nam",
    email: "hoai.sang050@gmail.com",
    phoneNumber: "0944552050",
  });
  ...
  const handleInputChange = (e) => {
    ...
    if (!value.trim()) {
      errorMessage = `Vui lòng nhập ${
        id === "name" ? "tên" : id === "email" ? "email" : "số điện thoại"
      }`;
    ...
    setFormErrors((prevErrors) => ({ ...prevErrors, [id]: errorMessage }));
  };
  ...
  useEffect(() => {
    setIsValidFormData(Object.values(formErrors).every((x) => x === ""));
  }, [formErrors, formData]);
      ...
      <div className=" text-white">
        ...
        <div className="w-full bg-slate-200/50 text-black text-[1.5rem]">
          <form className="grid grid-cols-1 gap-2 px-4">
            {[
              { labelName: "Họ và tên", type: "text", inputName: "name" },
              { labelName: "Email", type: "email", inputName: "email" },
              {
              ...
              <div key={i}>
                <div className="flex flex-col ">
                  ...
                  <motion.input
                    whileFocus={{ borderColor: "#2563eb", color: "#172554" }}
                    style={{
                      borderColor: formErrors[inputName] == "" ? "gray" : "red",
                    }}
            ...
            <motion.button
              ...
              animate={{
                backgroundColor: isValidFormData ? "#0284c7" : "#78716c",
              }}
